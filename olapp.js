  ...
  return new olapp.Project({
    ...
    view: new ol.View({
      projection: 'EPSG:3857',
        center: ol.proj.transform([106.347656, 14.944785], 'EPSG:4326', 'EPSG:3857'),
      maxZoom: 18,
      zoom: 5
    }),
      plugins: ['source/naturalearth.js', 'source/gsitiles.js', 'source/baselayers.js', 'source/geoserverlayers.js', 'source/vectorlayers.js', 'source/gist.js'],
    layers: [   // from bottom to top
      {source: 'BaseLayer', layer: 'osm'},    
      {source: 'GeoserverLayer', layer: 'vn'},
        { source: 'VectorLayer', layer: 'vn', options: { visible: true }}
      /*{source: 'BaseLayer', layer: 'std'},                                // 標準地図
